...
data class InterpretationIssue(val code: String, val message: String, val level: InterpretationIssueLevel = InterpretationIssueLevel.WARNING, val fieldKey: FieldKey? = null) {
    init {
