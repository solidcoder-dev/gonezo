...
data class AllowedValue(val stableValue: String, val label: String, val description: String? = null) {
    init {
...
data class FieldSpec(val key: FieldKey, val description: FieldDescription, val type: FieldType, val allowedValues: List<AllowedValue> = emptyList(), val required: Boolean = false, val format: String? = null) {
    init {
