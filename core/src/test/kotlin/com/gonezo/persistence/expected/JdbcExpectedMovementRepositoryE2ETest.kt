...
class JdbcExpectedMovementRepositoryE2ETest : SqliteE2ETest() {
    ...
    private fun expectedMovement(accountId: String = "account-1", merchant: String = "Client", originOccurrenceId: String? = null): ExpectedMovement = ExpectedMovement.create(
