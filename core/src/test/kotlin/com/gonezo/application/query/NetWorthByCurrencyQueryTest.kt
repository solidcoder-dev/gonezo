...
class NetWorthByCurrencyQueryTest {
    ...
    private fun transaction(type: String, amount: String, currency: String, occurredAt: String, status: String = "posted", accountId: AccountId = AccountId(UUID.fromString("00000000-0000-4000-8000-000000000001"))) = NetWorthTransactionRead(
        accountId = accountId,
        type = type,
        status = status,
