...
class InterpretationResultToMovementEntryDraftMapperTest {
    ...
    private fun result(type: FieldInterpretation, amount: FieldInterpretation, occurredOn: FieldInterpretation, note: FieldInterpretation, categoryId: FieldInterpretation? = null): InterpretationResult = InterpretationResult.fromDecoded(
        specId = InterpretationSpecId.of("movement-entry"),
        specVersion = InterpretationSpecVersion.of("v1"),
        fields = buildList {
    ...
    private fun result(type: FieldCandidate, amount: FieldCandidate, occurredOn: FieldCandidate, note: FieldCandidate, categoryId: FieldCandidate? = null): InterpretationResult = InterpretationResult.fromDecoded(
        specId = InterpretationSpecId.of("movement-entry"),
        specVersion = InterpretationSpecVersion.of("v1"),
        fields = buildList {
