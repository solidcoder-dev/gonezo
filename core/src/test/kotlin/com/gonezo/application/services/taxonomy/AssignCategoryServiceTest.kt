...
private class InMemoryAssignmentRepository : TransactionCategoryAssignmentRepository {
    ...
    override fun findByTransactionIds(transactionIds: Collection<UUID>): Map<UUID, TransactionCategoryAssignment> = transactionIds.mapNotNull { id -> assignments[id]?.let { id to it } }.toMap()
}
