...
private class StubListLedgerAccountsUC(private val accounts: List<Account>) : ListLedgerAccountsUC {
    override fun execute(): List<Account> = accounts
}

private class StubListCategoriesUC(private vararg val categories: Category) : ListCategoriesUC {
...
private class RecordingCategorizeLedgerTransactionUC : CategorizeLedgerTransactionUC {
    ...
    override fun execute(command: CategorizeLedgerTransactionCommand): TxCategorizationState {
        ...
        val resolvedCategoryId =
            command.categoryId ?: command.newCategoryName?.let { name ->
