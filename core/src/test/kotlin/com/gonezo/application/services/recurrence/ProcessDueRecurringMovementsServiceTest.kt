...
class ProcessDueRecurringMovementsServiceTest {
    ...
    fun `creates pending occurrence and outbox event and advances schedule`() {
        ...
        val service =
            ProcessDueRecurringMovementsService(
    ...
    private fun sampleMovement(startAt: Instant, createdAt: Instant): RecurringMovement = RecurringMovement.create(
    ...
    private class InMemoryOccurrenceRepository : RecurringMovementOccurrenceRepository {
        ...
        override fun listByRecurringMovement(recurringMovementId: RecurringMovementId): List<RecurringMovementOccurrence> = storage.values.filter { it.recurringMovementId == recurringMovementId }.sortedBy { it.dueAt }
    }
