    ...
    fun `imports utf16 mobills file and coordinates ledger with taxonomy`() {
        ...
        val importUC =
            ImportMobillsStatementService(
                ...
                CategorizeLedgerTransactionService(
                    ...
                    processCategorizationUC =
                    ProcessTransactionCategorizationService(
                        taxonomyAssignCategoryUC =
                        AssignCategoryToTransactionService(
                            categoryRepository = JdbcTaxonomyCategoryRepository(namedJdbc),
