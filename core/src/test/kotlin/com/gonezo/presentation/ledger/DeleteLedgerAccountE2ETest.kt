...
class DeleteLedgerAccountE2ETest : SqliteE2ETest() {
    ...
    fun `deletes account and all associated transaction projections`() {
        ...
        val accountId =
            app.ledgerOpenAccountUC.execute(
        ...
        val transactionId =
            app.ledgerRecordExpenseUC.execute(
        ...
        assertThat(
            db.jdbcTemplate.queryForObject("select count(*) from taxonomy_categories", Int::class.java),
        ).isEqualTo(categoryCountBefore + 1)
