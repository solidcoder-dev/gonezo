...
class ListCategoriesService(private val categoryRepository: CategoryRepository) : ListCategoriesUC {
    override fun execute(): List<CategoryWithUsage> = categoryRepository.listAll()
}

class RenameCategoryService(private val categoryRepository: CategoryRepository) : RenameCategoryUC {
...
class AssignCategoryToTransactionService(private val categoryRepository: CategoryRepository, private val assignmentRepository: TransactionCategoryAssignmentRepository) : AssignCategoryToTransactionUC {
...
class UnassignCategoryFromTransactionService(private val assignmentRepository: TransactionCategoryAssignmentRepository) : UnassignCategoryFromTransactionUC {
...
class CreateTagService(private val tagRepository: TagRepository) : CreateTagUC {
...
class RenameTagService(private val tagRepository: TagRepository) : RenameTagUC {
