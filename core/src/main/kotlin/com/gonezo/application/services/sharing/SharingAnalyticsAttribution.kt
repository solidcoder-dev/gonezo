...
data class SharingAnalyticsAttribution(
    val participantCount: Int,
    val settlementParticipantCount: Int,
    val participantAllocatedAmount: BigDecimal,
    val settlementRequiredAmount: BigDecimal,
) {
    init {
...
class SharingAnalyticsAttributionResolver(
    private val currencyScaleResolver: CurrencyScaleResolver = DefaultCurrencyScaleResolver,
) {
