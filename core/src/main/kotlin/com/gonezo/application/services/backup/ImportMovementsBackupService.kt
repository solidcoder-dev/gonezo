...
class ImportMovementsBackupService(
    ...
    private val transactionFactory: BackupTransactionFactory = BackupTransactionFactory(accountRepository),
    private val taxonomyAssignmentImporter: BackupTaxonomyAssignmentImporter = BackupTaxonomyAssignmentImporter(categoryRepository, tagRepository, categoryAssignmentRepository, tagAssignmentRepository, itemCategoryAssignmentRepository),
    private val masterDataImporter: BackupMasterDataImporter = BackupMasterDataImporter(accountRepository, categoryRepository, tagRepository),
