...
class ImportMovementsBackupService(private val accountRepository: LedgerAccountRepository, private val transactionRepository: LedgerTransactionRepository, private val categoryRepository: CategoryRepository, private val tagRepository: TagRepository, private val categoryAssignmentRepository: TransactionCategoryAssignmentRepository, private val tagAssignmentRepository: TransactionTagAssignmentRepository, private val itemCategoryAssignmentRepository: TransactionItemCategoryAssignmentRepository, private val consistencyBoundary: ConsistencyBoundary = ImmediateConsistencyBoundary, private val transactionFactory: BackupTransactionFactory = BackupTransactionFactory(accountRepository), private val taxonomyAssignmentImporter: BackupTaxonomyAssignmentImporter = BackupTaxonomyAssignmentImporter(categoryRepository, tagRepository, categoryAssignmentRepository, tagAssignmentRepository, itemCategoryAssignmentRepository), private val masterDataImporter: BackupMasterDataImporter = BackupMasterDataImporter(accountRepository, categoryRepository, tagRepository)) : ImportMovementsBackupUC {
