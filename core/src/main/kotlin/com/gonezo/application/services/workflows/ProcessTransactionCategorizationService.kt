...
class ProcessTransactionCategorizationService(private val taxonomyAssignCategoryUC: AssignCategoryToTransactionUC, private val stateRepository: TxCategorizationStateRepository) : ProcessTransactionCategorizationUC {
    ...
    private fun failedState(command: ProcessTransactionCategorizationCommand, attempts: Int, createdAt: java.time.Instant, code: String, message: String): TxCategorizationState = TxCategorizationState(
        transactionId = command.transactionId,
        requestedCategoryId = command.requestedCategoryId,
