...
class ImportMobillsStatementService(private val listAccountsUC: ListLedgerAccountsUC, private val openAccountUC: OpenLedgerAccountUC, private val recordExpenseUC: RecordLedgerExpenseUC, private val recordIncomeUC: RecordLedgerIncomeUC, private val listCategoriesUC: ListCategoriesUC, private val categorizeLedgerTransactionUC: CategorizeLedgerTransactionUC, private val applyTransactionTagsUC: ApplyTransactionTagsUC) : ImportMobillsStatementUC {
    ...
    private fun importRow(row: ImportMobillsRow, requestedAt: Instant, policy: ImportMobillsPolicy, accountIndex: MutableMap<String, Account>, categoryIndex: MutableMap<String, CategoryId>): TransactionId {
    ...
    private fun resolveAccount(row: ImportMobillsRow, requestedAt: Instant, policy: ImportMobillsPolicy, accountIndex: MutableMap<String, Account>, currencyCode: CurrencyCode): Account {
