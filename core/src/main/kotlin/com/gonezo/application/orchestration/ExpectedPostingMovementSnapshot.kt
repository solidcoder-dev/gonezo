...
data class ExpectedPostingMovementSnapshot(val accountId: String, val type: ExpectedMovementType, val amount: BigDecimal, val currency: String, val description: String?, val merchant: String?, val splitItems: List<ExpectedPostingSplitItem>) {
    init {
