...
class InterpretationResultToMovementEntryDraftMapper(private val expectedSpecId: String = "movement-entry", private val expectedSpecVersion: String = "v1", private val minimumConfidence: Double = 0.5) {
    init {
    ...
    fun map(result: InterpretationResult): MovementEntryDraft {
        ...
        require(
            result.specVersion.value == expectedSpecVersion,
        ) { "interpretation result spec version does not match the movement draft schema" }
    ...
    private fun mapType(result: InterpretationResult, issues: MutableList<MovementEntryDraftIssue>): MovementEntryDraftType? {
        ...
        return when (interpretation) {
            ...
            is FieldInterpretation.Resolved -> {
                ...
                val enumValue =
                    candidate.value as? StructuredValue.Enum
    ...
    private fun mapDecimal(result: InterpretationResult, key: String, field: MovementEntryDraftField, issues: MutableList<MovementEntryDraftIssue>): BigDecimal? {
        ...
        return when (interpretation) {
            ...
            is FieldInterpretation.Resolved -> {
                ...
                val value =
                    candidate.value as? StructuredValue.Decimal
    ...
    private fun mapDate(result: InterpretationResult, key: String, field: MovementEntryDraftField, issues: MutableList<MovementEntryDraftIssue>): LocalDate? {
        val interpretation = interpretationFor(result, key)
        return when (interpretation) {
            FieldInterpretation.Missing -> {
                issues += issue(field, MovementEntryDraftIssueCode.FIELD_MISSING)
            ...
            is FieldInterpretation.Resolved -> {
                ...
                val value =
                    candidate.value as? StructuredValue.Date
    ...
    private fun mapText(result: InterpretationResult, key: String, field: MovementEntryDraftField, issues: MutableList<MovementEntryDraftIssue>): String? {
        val interpretation = interpretationFor(result, key)
        return when (interpretation) {
            FieldInterpretation.Missing -> {
                issues += issue(field, MovementEntryDraftIssueCode.FIELD_MISSING)
            ...
            is FieldInterpretation.Resolved -> {
                ...
                val value =
                    when (val structuredValue = candidate.value) {
    ...
    private fun mapCategory(result: InterpretationResult, issues: MutableList<MovementEntryDraftIssue>): String? {
