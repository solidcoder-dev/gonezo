...
data class ImportMovementsBackupRowResult(val sourceLine: Int, val status: ImportMovementsBackupRowStatus, val transactionId: TransactionId? = null, val errorCode: String? = null, val errorMessage: String? = null)

data class ImportMovementsBackupResult(val rows: List<ImportMovementsBackupRowResult>) {
