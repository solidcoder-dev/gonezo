...
data class MovementEntryCategoryOption(val id: String, val label: String, val description: String? = null) {
    init {
...
class MovementEntryInterpretationSpecFactory {
    ...
    private fun enumField(key: String, description: String, allowedValues: List<AllowedValue>): FieldSpec = FieldSpec(
        key = FieldKey.of(key),
        description = FieldDescription.of(description),
        type = FieldType.ENUM,
