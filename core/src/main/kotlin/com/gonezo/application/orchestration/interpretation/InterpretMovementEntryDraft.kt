...
data class InterpretMovementEntryDraftCommand(val transcript: String, val inputLanguage: String, val currentDate: LocalDate, val zoneId: ZoneId, val locale: String, val accountCurrency: String, val categories: List<MovementEntryCategoryOption>)
...
data class InterpretMovementEntryDraftFailure(val code: InterpretMovementEntryDraftFailureCode, val recoverable: Boolean)
...
class InterpretMovementEntryDraft(private val inputInterpreter: InputInterpreter, private val specFactory: MovementEntryInterpretationSpecFactory, private val resultMapper: InterpretationResultToMovementEntryDraftMapper) {
    ...
    private fun mapSuccess(result: InterpretationResult, expectedSpec: dev.solidcoder.interpretation.domain.InterpretationSpec): InterpretMovementEntryDraftOutcome {
    ...
    private fun failure(code: InterpretMovementEntryDraftFailureCode, recoverable: Boolean): InterpretMovementEntryDraftOutcome = InterpretMovementEntryDraftOutcome.Failure(InterpretMovementEntryDraftFailure(code, recoverable))
