...
interface PendingExpectedOverviewReadPort {
    fun read(): List<PendingExpectedMovementRead>
}
...
data class PendingExpectedOverviewResult(val expenses: PendingExpectedTypeSummary, val incomes: PendingExpectedTypeSummary)

interface GetPendingExpectedOverviewQuery {
    fun execute(query: PendingExpectedOverviewQuery): PendingExpectedOverviewResult
}

class GetPendingExpectedOverviewService(private val readPort: PendingExpectedOverviewReadPort) : GetPendingExpectedOverviewQuery {
