...
class GetNetWorthByCurrencyService(private val readPort: NetWorthByCurrencyReadPort) : GetNetWorthByCurrencyQuery {
    ...
    private fun sumBalance(transactions: List<NetWorthTransactionRead>, before: Instant?): BigDecimal = transactions
        .asSequence()
