...
data class ResolveExpectedMovementCommand(val expectedMovementId: ExpectedMovementId, val transactionId: String, val resolvedAt: Instant)

interface ResolveExpectedMovementUC {
    fun execute(command: ResolveExpectedMovementCommand)
}

data class DismissExpectedMovementCommand(val expectedMovementId: ExpectedMovementId, val dismissedAt: Instant)
