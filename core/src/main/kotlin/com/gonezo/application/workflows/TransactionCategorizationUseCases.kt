...
data class CategorizeLedgerTransactionCommand(val transactionId: TransactionId, val transactionType: String, val categoryId: CategoryId? = null, val newCategoryName: String? = null, val requestedAt: Instant)
