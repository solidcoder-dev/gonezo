...
data class HandleRecurringMovementDueForExpectedCommand(val event: RecurringMovementDueIntegrationEvent, val handledAt: Instant)

data class HandleRecurringMovementDueForExpectedResult(val expectedMovementId: ExpectedMovementId, val created: Boolean)
...
data class ApproveRecurringExpectedMovementCommand(val expectedMovementId: ExpectedMovementId, val approvedAt: Instant)

data class ApproveRecurringExpectedMovementResult(val transactionId: String)
...
data class DismissRecurringExpectedMovementCommand(val expectedMovementId: ExpectedMovementId, val dismissedAt: Instant)
