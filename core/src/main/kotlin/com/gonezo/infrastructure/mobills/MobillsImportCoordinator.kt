...
class MobillsImportCoordinator(private val parser: MobillsTsvParser, private val importStatementUC: ImportMobillsStatementUC) {
    fun importBytes(bytes: ByteArray, requestedAt: Instant, policy: ImportMobillsPolicy = ImportMobillsPolicy()): ImportMobillsResult {
