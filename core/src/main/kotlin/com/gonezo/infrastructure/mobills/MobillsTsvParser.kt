...
data class MobillsNormalizedRow(val sourceLine: Int, val accountName: String, val occurredAt: Instant, val value: BigDecimal, val currency: String, val description: String?, val merchant: String?, val category: String?, val tags: List<String>)

data class MobillsParseIssue(val lineNumber: Int, val code: String, val message: String)

data class MobillsParseResult(val rows: List<MobillsNormalizedRow>, val issues: List<MobillsParseIssue>)

class MobillsTsvParser(private val defaultCurrency: String = "EUR") {
    ...
    private fun requireHeaderIndex(headers: List<String>, vararg aliases: String): Int = headerIndex(headers, *aliases)
