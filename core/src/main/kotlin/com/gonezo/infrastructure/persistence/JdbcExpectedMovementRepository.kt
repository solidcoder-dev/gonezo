...
@Repository
class JdbcExpectedMovementRepository(private val jdbcTemplate: NamedParameterJdbcTemplate) : ExpectedMovementRepository {
    ...
    private fun params(movement: ExpectedMovement): MapSqlParameterSource = MapSqlParameterSource()
