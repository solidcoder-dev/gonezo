...
@Repository
class JdbcLedgerAccountRepository(private val jdbcTemplate: NamedParameterJdbcTemplate) : LedgerAccountRepository {
    ...
    override fun deleteById(id: AccountId) {
        ...
        jdbcTemplate.update(
            "delete from ledger_accounts where id = :id",
            MapSqlParameterSource("id", id.toString()),
        )
    }
