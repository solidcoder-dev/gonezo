...
@Repository
class JdbcSharingPersonRepository(private val jdbcTemplate: NamedParameterJdbcTemplate) : SharingPersonRepository {
    ...
    override fun findByNormalizedName(normalizedName: String): SharingPerson? = jdbcTemplate
        .query(
            """
    ...
    override fun listActive(): List<SharingPerson> = jdbcTemplate.query(
        """
            select id, display_name, normalized_name, created_at, archived_at
            from sharing_persons
