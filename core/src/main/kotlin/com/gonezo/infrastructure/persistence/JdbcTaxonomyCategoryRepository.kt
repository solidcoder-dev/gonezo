...
@Repository
class JdbcTaxonomyCategoryRepository(private val jdbcTemplate: NamedParameterJdbcTemplate) : CategoryRepository {
    ...
    private fun mapCategory(rs: ResultSet): Category = Category(
