...
sealed interface AllocationRule {
    ...
    data class Percentages(val payerPercentage: BigDecimal, val participantPercentages: List<BigDecimal>) : AllocationRule
...
object AllocationCalculator {
    ...
    fun allocateEqualSplit(total: BigDecimal, participantCount: Int, scale: Int): List<BigDecimal> {
        ...
        val unit =
            total
                .divide(BigDecimal(participantCount), scale + 8, java.math.RoundingMode.DOWN)
