...
data class RecurrenceRule(val frequency: RecurrenceFrequency, val interval: Int = 1, val weeklyDays: Set<DayOfWeek> = emptySet(), val monthlyPattern: MonthlyPattern = MonthlyPattern.DAY_OF_MONTH, val dayOfMonth: Int? = null, val monthlyWeekOrdinal: Int? = null, val monthlyWeekday: DayOfWeek? = null) {
    init {
