...
data class Tag(val id: TagId, val name: String, val status: TagStatus, val createdAt: Instant, val archivedAt: Instant?) {
    init {
    ...
    companion object {
        fun create(id: TagId, name: String, createdAt: Instant): Tag = Tag(
            id = id,
            name = name.trim(),
