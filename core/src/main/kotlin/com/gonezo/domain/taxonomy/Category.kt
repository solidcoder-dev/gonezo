...
data class Category(val id: CategoryId, val name: String, val appliesTo: CategoryAppliesTo, val status: CategoryStatus, val createdAt: Instant, val archivedAt: Instant?) {
    init {
    ...
    companion object {
        fun create(id: CategoryId, name: String, appliesTo: CategoryAppliesTo, createdAt: Instant): Category = Category(
            id = id,
            name = name.trim(),
            appliesTo = appliesTo,
