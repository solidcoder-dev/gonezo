...
data class ShareParticipant(val id: ShareParticipantId, val personId: SharingPersonId, val amount: BigDecimal, val reimbursable: Boolean, val expectedMovementId: String?) {
    init {
