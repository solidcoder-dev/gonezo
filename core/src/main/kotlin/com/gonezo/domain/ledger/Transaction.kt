...
data class Transaction(val id: TransactionId, val accountId: AccountId, val type: TransactionType, val amount: Money, val occurredAt: Instant, val description: String?, val merchant: String?, val status: TransactionStatus, val items: List<TransactionItem>, val linkedTransactionId: TransactionId?) {
    init {
    ...
    companion object {
        fun recordIncome(id: TransactionId, accountId: AccountId, amount: Money, occurredAt: Instant, description: String?, merchant: String?): Transaction = create(
            id = id,
            accountId = accountId,
        ...
        fun recordExpense(id: TransactionId, accountId: AccountId, amount: Money, occurredAt: Instant, description: String?, merchant: String?): Transaction = create(
            id = id,
            accountId = accountId,
        ...
        fun createExpenseDraft(id: TransactionId, accountId: AccountId, amount: Money, occurredAt: Instant, description: String?, merchant: String?): Transaction = create(
            id = id,
            accountId = accountId,
            type = TransactionType.EXPENSE,
            amount = amount,
        ...
        fun recordTransferOut(id: TransactionId, accountId: AccountId, amount: Money, occurredAt: Instant, description: String?, linkedTransactionId: TransactionId): Transaction = create(
            id = id,
            accountId = accountId,
        ...
        fun recordTransferIn(id: TransactionId, accountId: AccountId, amount: Money, occurredAt: Instant, description: String?, linkedTransactionId: TransactionId): Transaction = create(
            id = id,
            accountId = accountId,
        ...
        private fun create(id: TransactionId, accountId: AccountId, type: TransactionType, amount: Money, occurredAt: Instant, description: String?, merchant: String?, status: TransactionStatus, items: List<TransactionItem>, linkedTransactionId: TransactionId?): Transaction = Transaction(
            id = id,
            accountId = accountId,
            type = type,
            amount = amount,
