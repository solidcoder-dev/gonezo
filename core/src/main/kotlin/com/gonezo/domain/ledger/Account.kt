...
data class Account(val id: AccountId, val name: String, val type: AccountType, val currency: CurrencyCode, val status: AccountStatus, val createdAt: Instant, val archivedAt: Instant?) {
    init {
    ...
    companion object {
        fun open(id: AccountId, name: String, type: AccountType, currency: CurrencyCode, createdAt: Instant): Account = Account(
            id = id,
            name = name.trim(),
            type = type,
            currency = currency,
