...
data class Transcript(val text: String, val segments: List<TranscriptSegment> = emptyList()) {
    init {
...
data class TranscriptSegment(val text: String, val startMs: Long = 0, val endMs: Long = 0, val noSpeechProbability: Float = 0f) {
    init {
