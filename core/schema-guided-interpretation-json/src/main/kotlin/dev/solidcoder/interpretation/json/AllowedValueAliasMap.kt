...
internal data class AllowedValueAliasMap(private val aliasesByStableValue: Map<String, String>, private val stableValueByAlias: Map<String, AllowedValue>) {
    val allowedValues: List<AllowedValueAlias> =
        stableValueByAlias.entries
...
internal data class AllowedValueAlias(val alias: String, val label: String, val description: String?)
