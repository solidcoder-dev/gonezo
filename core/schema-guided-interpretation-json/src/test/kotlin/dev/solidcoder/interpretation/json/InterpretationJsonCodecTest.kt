...
class InterpretationJsonCodecTest {
    ...
    fun `rejects incompatible request shapes`() {
        ...
        assertThatThrownBy {
            codec.decodeRequest(
                """{"contractVersion":"1","input":"hola","spec":{"contractVersion":"1","specId":"gonezo-movement-entry","version":"1","fields":[{"key":"amount","description":"Amount","type":"decimal","required":false}]},"context":{"entries":[]}}""",
            )
        }.isInstanceOf(IllegalArgumentException::class.java)

        assertThatThrownBy {
            codec.decodeRequest(
                """{"contractVersion":"1","input":"hola","spec":{"contractVersion":"1","specId":"gonezo-movement-entry","version":"1","fields":[{"key":"amount","description":"Amount","type":"DECIMAL","required":false}],"unexpected":true},"context":{"entries":[]}}""",
            )
        }.isInstanceOf(IllegalArgumentException::class.java)

        assertThatThrownBy {
            codec.decodeRequest(
                """{"contractVersion":"1","input":"hola","spec":{"contractVersion":"1","specId":"gonezo-movement-entry","version":"1","fields":[{"key":"amount","description":"Amount","type":"DECIMAL","required":false}]},"context":{"entries":[{"key":"currentDate","value":{"value":"2026-07-16"}}]}}""",
            )
        }.isInstanceOf(IllegalArgumentException::class.java)
    }
    ...
    fun `rejects invalid result payloads`() {
        ...
        assertThatThrownBy {
            codec.decodeResult(
                """{"contractVersion":"1","specId":"purchase","version":"1","fields":[{"key":"amount","interpretation":{"kind":"resolved","candidate":{"value":{"type":"decimal","value":"1.23"},"confidence":1.2}}}],"issues":[]}""",
            )
        }.isInstanceOf(IllegalArgumentException::class.java)

        assertThatThrownBy {
            codec.decodeResult(
                """{"contractVersion":"1","specId":"purchase","version":"1","fields":[{"key":"type","interpretation":{"kind":"resolved","candidate":{"value":{"type":"enum","value":"alpha"},"confidence":0.9}}},{"key":"type","interpretation":{"kind":"resolved","candidate":{"value":{"type":"enum","value":"beta"},"confidence":0.9}}}],"issues":[]}""",
            )
        }.isInstanceOf(IllegalArgumentException::class.java)
    }
    ...
    private fun contextEntry(context: InterpretationContext, key: String): ContextEntry = context.entries.first { it.key.value == key }
}
