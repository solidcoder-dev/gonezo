...
class MacroAnalyticsPublicationWireV6Parser : MacroAnalyticsPublicationPayloadParser {
    override fun parse(json: String): ValidatedMacroAnalyticsPublication {
        ...
        return ValidatedMacroAnalyticsPublication(
            ...
            MacroAnalyticsContribution(SchemaVersion(6), ContributionDimensions(country, region, sex, ageBand), FinancialContribution(financialCurrencies), CategoryContribution(categoryCurrencies), RecurringContribution(recurringCurrencies), SharingContribution(sharingCurrencies), merchantContribution, balanceContribution),
        )
    }
