...
class MacroAnalyticsPublicationWireV5Parser : MacroAnalyticsPublicationPayloadParser {
    override fun parse(json: String): ValidatedMacroAnalyticsPublication {
        ...
        require(root.requiredInt("protocolVersion") == 5) { "Protocol and schema versions must both be 5" }
