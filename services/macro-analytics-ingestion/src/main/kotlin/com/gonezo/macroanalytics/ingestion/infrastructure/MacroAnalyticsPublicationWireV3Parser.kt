...
class MacroAnalyticsPublicationWireV3Parser : MacroAnalyticsPublicationPayloadParser {
    override fun parse(json: String): ValidatedMacroAnalyticsPublication {
        ...
        require(root.requiredInt("protocolVersion") == 3) { "Protocol and schema versions must both be 3" }
