...
data class ContributorCredentialRegistrationV1(val contributorId: String, val keyId: String, val algorithm: String, val publicKey: ByteArray, val proof: ByteArray)
