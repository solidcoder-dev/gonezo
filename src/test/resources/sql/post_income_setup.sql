...
values ('11111111-1111-1111-1111-111111111111', '22222222-2222-2222-2222-222222222222', 'Primary Checking', 'bank', 'USD');
...
values ('cccccccc-cccc-cccc-cccc-cccccccccccc', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'Income', 'savings_goal', false, null, null);
