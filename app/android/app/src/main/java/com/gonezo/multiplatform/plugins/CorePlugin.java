...
public class CorePlugin extends Plugin {
  ...
  public void ledgerOpenAccount(PluginCall call) {
    ...
    try {
      com.gonezo.multiplatform.core.AndroidLedgerCore core =
        com.gonezo.multiplatform.core.AndroidLedgerCore.getInstance(getContext());
  ...
  public void ledgerListAccounts(PluginCall call) {
    try {
      com.gonezo.multiplatform.core.AndroidLedgerCore core =
        com.gonezo.multiplatform.core.AndroidLedgerCore.getInstance(getContext());
      java.util.List<com.gonezo.multiplatform.core.AndroidLedgerCore.LedgerAccountView> accounts = core.listAccounts();
      org.json.JSONArray items = new org.json.JSONArray();
      for (com.gonezo.multiplatform.core.AndroidLedgerCore.LedgerAccountView account : accounts) {
  ...
  public void ledgerGetAccountSummary(PluginCall call) {
    ...
    try {
      com.gonezo.multiplatform.core.AndroidLedgerCore core =
        com.gonezo.multiplatform.core.AndroidLedgerCore.getInstance(getContext());
      com.gonezo.multiplatform.core.AndroidLedgerCore.LedgerAccountSummaryView summary = core.getAccountSummary(accountId);
      JSObject result = new JSObject();
  ...
  public void ledgerListTransactions(PluginCall call) {
    ...
    try {
      com.gonezo.multiplatform.core.AndroidLedgerCore core =
        com.gonezo.multiplatform.core.AndroidLedgerCore.getInstance(getContext());
      java.util.List<com.gonezo.multiplatform.core.AndroidLedgerCore.LedgerTransactionView> transactions = core.listTransactions(
        accountId,
        limit,
        fromDate,
        toDate,
      ...
      org.json.JSONArray items = new org.json.JSONArray();
      for (com.gonezo.multiplatform.core.AndroidLedgerCore.LedgerTransactionView tx : transactions) {
        JSObject item = new JSObject();
        item.put("id", tx.id());
        ...
        for (com.gonezo.multiplatform.core.AndroidLedgerCore.LedgerTransactionItemView txItem : tx.items()) {
