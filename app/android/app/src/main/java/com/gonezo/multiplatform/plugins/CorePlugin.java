...
@CapacitorPlugin(name = "CorePlugin") public class CorePlugin extends Plugin {
  ...
  @PluginMethod public void analyticsListIgnoredMovements(PluginCall call) { new AnalyticsPluginHandler(getContext()).analyticsListIgnoredMovements(call); } @PluginMethod public void analyticsListMovementFacts(PluginCall call) { new AnalyticsPluginHandler(getContext()).analyticsListMovementFacts(call); } @PluginMethod public void analyticsGetAccountBalanceSnapshot(PluginCall call) { new AnalyticsPluginHandler(getContext()).analyticsGetAccountBalanceSnapshot(call); } @PluginMethod public void analyticsGetAccountBalanceCoverage(PluginCall call) { new AnalyticsPluginHandler(getContext()).analyticsGetAccountBalanceCoverage(call); }
