...
public class CorePlugin extends Plugin {
  ...
  @PluginMethod public void notificationsList(PluginCall call) { new NotificationsPluginHandler(this).list(call); } @PluginMethod public void notificationsCountUnread(PluginCall call) { new NotificationsPluginHandler(this).countUnread(call); }
  @PluginMethod public void notificationsMarkRead(PluginCall call) { new NotificationsPluginHandler(this).markRead(call); } @PluginMethod public void notificationsMarkAllRead(PluginCall call) { new NotificationsPluginHandler(this).markAllRead(call); }
  @PluginMethod public void notificationsGetPermissionState(PluginCall call) { new NotificationsPluginHandler(this).permissionState(call); } @PluginMethod public void notificationsRequestPermission(PluginCall call) { new NotificationsPluginHandler(this).requestPermission(call); }
  @PluginMethod public void notificationsOpenSettings(PluginCall call) { new NotificationsPluginHandler(this).openSettings(call); }
}
