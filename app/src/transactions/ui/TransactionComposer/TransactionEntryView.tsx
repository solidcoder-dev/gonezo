  ...
  return (
    <TransactionComposerView
      required={{
        ...
        expenseItemTagNames: required.state.splitItemTagNames,
        expenseItemTagQuery: required.state.splitItemTagQuery,
        expenseItemTagOptions: required.state.splitItemTagOptions,
        expenseItemTagSuggestions: required.state.splitItemTagSuggestions,
        expenseItemTagCreateCandidate: required.state.splitItemTagCreateCandidate,
      ...
      provided={{
        ...
        onSetExpenseItemTagQuery: provided.commands.setSplitItemTagQuery ?? (() => {}),
        onSelectExpenseItemTag: provided.commands.selectSplitItemTag ?? (() => {}),
        onCreateExpenseItemTag: provided.commands.createSplitItemTag ?? (() => {}),
        onRemoveExpenseItemTag: provided.commands.removeSplitItemTag ?? (() => {}),
        onRemoveLastExpenseItemTag: provided.commands.removeLastSplitItemTag ?? (() => {}),
