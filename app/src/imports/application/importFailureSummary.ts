import type { TransactionsImportRowResult } from './transactionsImport.types';
import { normalizeImportErrorCode } from '../domain/importFailure';

export type ImportRowStatus = 'imported' | 'failed' | 'skipped';

export type ImportRowResult = TransactionsImportRowResult;
...
export { normalizeImportErrorCode };
