...
export interface CorePlugin {
  ...
  ledgerReplacePostedTransactionItems(options: LedgerReplacePostedTransactionItemsInput): Promise<void>;
  ...
  sharingRenamePerson(options: SharingRenamePersonInput): Promise<void>;
