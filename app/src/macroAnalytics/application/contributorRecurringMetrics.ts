...
function recurringExpenseAmount(contribution: MacroAnalyticsContributionV3 | MacroAnalyticsContributionV4 | MacroAnalyticsContributionV5 | MacroAnalyticsContributionV6 | MacroAnalyticsContributionV7, currency: string, source: RecurringFactSource): string {
