...
import type { MacroAnalyticsContribution, MacroAnalyticsContributionV3, MacroAnalyticsContributionV4 } from '../domain/macroAnalyticsContribution';
...
function recurringExpenseAmount(contribution: MacroAnalyticsContributionV3 | MacroAnalyticsContributionV4, currency: string, source: RecurringFactSource): string {
