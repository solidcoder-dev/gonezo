import type { AccountsCorePort } from '../application/useAccountPageOrchestrator';
import { useAccountPageOrchestrator } from '../application/useAccountPageOrchestrator';
...
export function AccountPageView({ core }: Props) {
  const model = useAccountPageOrchestrator(core);
