...
export function MovementsSearchFilters({ required, provided }: MovementsSearchFiltersProps) {
  ...
  return (
    <section className="stack" aria-label="Search controls">
      <div className="segmented segmented-2" role="radiogroup" aria-label="Search source">
        <button
          type="button"
          className={filters.source === 'posted' ? 'segment active' : 'segment'}
        ...
        <button
          type="button"
          className={filters.source === 'scheduled' ? 'segment active' : 'segment'}
      ...
      <div className="quick-row">
        ...
        <button
          ...
          onClick={filtersOpen ? provided.commands.closeFilters : provided.commands.openFilters}
          disabled={disabled}
        >
      ...
      {filtersOpen ? (
        <div className="item-editor stack" aria-label="Movement filters">
          <input
            type="text"
            aria-label="Merchant"
          ...
          <div className="quick-row">
            <button type="button" className="text-button" onClick={provided.commands.toggleAdvancedFilters} disabled={disabled}>
              {filtersAdvancedOpen ? 'Less options' : 'Advanced filters'}
            </button>
          </div>

          {filtersAdvancedOpen ? (
            <div className="stack" aria-label="Advanced movement filters">
              <div className="stack">
              ...
              <div className="stack">
                ...
                <div className="segmented segmented-2" role="radiogroup" aria-label="Sort by">
                  <button
                    type="button"
                    className={filters.sortField === 'date' ? 'segment active' : 'segment'}
      ...
      <div className="quick-row">
        <button type="button" className="text-button" onClick={provided.commands.applyFilters} disabled={disabled}>
          Search
        </button>
      </div>
