...
@Testcontainers
class PostExpensePostedDatePolicyE2ETest {
  ...
  fun setup() {
    flyway.migrate()
    val resource = resourceLoader.getResource("classpath:sql/post_expense_posted_date_policy_setup.sql")
